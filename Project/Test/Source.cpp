...
int massTextureRow = 0;
int massTextureColumn = 0;
...
float mass1EngineForce = 0;
float mass1Direction = 0;
float mass1Mass = 0;
int mass1FrameCounter = 0;
int mass1ID = 0;
D3DXVECTOR2 mass1Scaling;
D3DXVECTOR2 mass1SpriteCentre;
float mass1RotationSpeed = 0;
int mass1HP;
...
float mass2EngineForce = 0;
float mass2Direction = 0;
float mass2Mass = 0;
int mass2FrameCounter = 0;
int mass2ID = 0;
D3DXVECTOR2 mass2Scaling;
D3DXVECTOR2 mass2SpriteCentre;
float mass2RotationSpeed = 0;
int mass2HP;
//int delayFactor = 0;
